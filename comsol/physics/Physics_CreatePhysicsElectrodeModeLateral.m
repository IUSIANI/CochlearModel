function model  = Physics_CreatePhysicsElectrodeModeLateral(model, stimulationCurrent, boundaryRadius)
    ...
    model.component('comp1').physics('ec').feature('fp12').selection.set([77 94]);
    model.component('comp1').physics('ec').create('fp4', 'FloatingPotential', 2);
    model.component('comp1').physics('ec').feature('fp4').selection.set([78 95]);
    model.component('comp1').physics('ec').create('fp3', 'FloatingPotential', 2);
    model.component('comp1').physics('ec').feature('fp3').selection.set([79 96]);
    model.component('comp1').physics('ec').create('fp2', 'FloatingPotential', 2);
    model.component('comp1').physics('ec').feature('fp2').selection.set([80 97]);
    model.component('comp1').physics('ec').create('fp1', 'FloatingPotential', 2);
    model.component('comp1').physics('ec').feature('fp1').selection.set([81 98]);
    
    
    model.component('comp1').physics('ec').create('fp6', 'FloatingPotential', 2);
    model.component('comp1').physics('ec').feature('fp6').selection.set([83 100]);
    model.component('comp1').physics('ec').create('fp7', 'FloatingPotential', 2);
    model.component('comp1').physics('ec').feature('fp7').selection.set([84 101]);
    model.component('comp1').physics('ec').create('fp8', 'FloatingPotential', 2);
    model.component('comp1').physics('ec').feature('fp8').selection.set([85 102]);
    model.component('comp1').physics('ec').create('fp9', 'FloatingPotential', 2);
    model.component('comp1').physics('ec').feature('fp9').selection.set([86 103]);
    model.component('comp1').physics('ec').create('fp10', 'FloatingPotential', 2);
    model.component('comp1').physics('ec').feature('fp10').selection.set([87 104]);

    model.component('comp1').physics('ec').create('ncd1', 'NormalCurrentDensity', 2);
    model.component('comp1').physics('ec').feature('ncd1').selection.set([82 99]);
