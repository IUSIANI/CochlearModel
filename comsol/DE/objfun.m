...
[error, NRTAmplitud, Model_struct.model] = errorFit(Model_struct.model, Model_struct.currentDensityAtNeurons, ...
                                       Model_struct.nNeuronasSimuladas, FVr_temp(1), FVr_temp(2), FVr_temp(3), FVr_temp(4), Model_struct.C_k, ...
                                       Model_struct.W, Model_struct.V, ...
                                       Model_struct.NRT_real_k_Amplitude, Model_struct.NRT_real_k_Rec_Elect);
F_cost = error;
